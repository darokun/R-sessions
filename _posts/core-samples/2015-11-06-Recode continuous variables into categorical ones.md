...
{% highlight r %}
age.cat1 <- NULL                          # new empty vector: age.cat1
age.cat1[age >= 20 & age <= 34] <- 1      # First level: 20-34
...
age.cat1 <- as.factor(age.cat1)           # Convert age.cat1 into factor
...
age.cat4 <- as.factor(age.cat4)                       # covert to factor 
tab$age.cat4 <- age.cat4                              # add to data set
